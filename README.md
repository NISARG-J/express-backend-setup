# Express Backend Setup CLI

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![NPM Version](https://img.shields.io/npm/v/express-backend-setup.svg)](https://www.npmjs.com/package/express-backend-setup)

**Express Backend Setup CLI** is a robust, developer-first command-line tool designed for scaffolding production-ready Express.js applications instantly — just like `create-react-app` but for your Node.js backend.
...
```bash
npx express-backend-setup --crud Product
```
...
We welcome contributions to the Express Backend Setup CLI!
